var person_settings = {
  ...
  user_pop_up_text: "#warning_alert", // место для вставки текста в этом окне
  user_pop_up_close_btn: "", // кнопка для закрытия окна
  ...
  warning_block: "#warning_alert", // идентификатор(id или class) блока предупреждения
  warning_block_text: "#warning_alert", // место для вставки текста в этом блоке
  ...
  notice_type: "user_warning", // тип уведомлений 
  ...
  send_type: "submit", // тип отправки данных (синхронный или асинхронный)
  ...
  loading_id: "send_btn", // указывает id для изображения загрузчика
  loading_class: "", // указывает class для изображения загрузчика
  ...
  loading_time: "loading", // после какого события показывается окно загрузки (Доступные значения: "send", "check", "loading")
  ...
  form_title: "Покупайте у нас!", // Заголовок формы
  form_title_box: "#title",// Блок в котором отображать Заголовок формы (Например .block_title)
  form_title2: "При покупке у нас Вы получите скидку 25%", // Подзаголовок формы
  form_title2_box: "#title_2", // Блок в котором отображать подзаголовок формы (Например .block)
